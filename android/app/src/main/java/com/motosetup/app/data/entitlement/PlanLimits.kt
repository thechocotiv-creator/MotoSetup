...
private const val FREE_AI_ADVICE_LIMIT = 1
...
/** aiAdviceUsedToday è già "azzerato" a monte se l'ultimo utilizzo non è di oggi — vedi FirebaseEntitlementStore. */
fun canAskAiAdvice(aiAdviceUsedToday: Int, isPremium: Boolean): Boolean =
    isPremium || aiAdviceUsedToday < FREE_AI_ADVICE_LIMIT
