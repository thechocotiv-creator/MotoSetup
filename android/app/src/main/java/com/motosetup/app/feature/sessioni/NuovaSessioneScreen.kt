...
/**
 * Placeholder Fase 2 — contenuto reale (carousel picker Moto/Pista/Meteo,
 * gating limite run/moto) arriva in Fase 4. Vedi design_handoff_motosetup_app/README.md #3a.
 */
@Composable
fun NuovaSessioneScreen() {
    Column(
        ...
        Text(text = "Nuova sessione", style = AppLargeTitle, color = AppColor.textPrimary)
